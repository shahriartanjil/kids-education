            ...
            <footer className="footer sm:footer-horizontal bg-sky-400  p-30">
                <nav>
                    <div className="flex gap-2">
                        ...
                        <a className=" text-xl text-white font-bold mt-4">Kids <br /> Education </a>
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur
                        earum reiciendis <br /> est placeat dolores provident atque nihil corporis impedit blanditiis?</p>
                </nav>
                <nav >
                    <h6 className="footer-title text-xl text-white">About School</h6>
                ...
                <nav>
                    <h6 className="footer-title text-xl ">Keep In Touch</h6>
